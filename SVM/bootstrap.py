...
data=[go.Bar(x=['Computer_technology','Telecommunication','Electrical machinary'],
            y=values,
             textposition="outside",
            marker=dict(color=["green","brown","blue","red"]))]
layout=go.Layout(title="Percent of Entities in Description",
                 hovermode="x",
                 plot_bgcolor="white")
fig=go.Figure(data=data,layout=layout)

dropdown_variables=['Electrical machinary', 'Telecommunication',
       'Computer_technology']
...
def update_fig(number):
    ...
    data=[go.Bar(x=['Computer_technology','Telecommunication','Electrical machinary'],
                 y=values,
                 textposition="outside",
                 marker={'color': ["green", "brown", "blue", "red"]})]
